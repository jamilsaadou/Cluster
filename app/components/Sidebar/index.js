...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 z-40 h-screen bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 shadow-lg
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto p-4 sidebar-scroll">
          <div className="space-y-6">
            {/* Dashboard Section */}
            <div>
              <h3 className={`text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 ${isCollapsed && !isMobile ? 'text-center' : ''}`}>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 p-4 space-y-2">
          ...
          <Link
            ...
            onClick={closeMobileSidebar}
            className={`
              flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors
              ${isCollapsed && !isMobile ? 'justify-center px-2' : ''}
            `}
          >
